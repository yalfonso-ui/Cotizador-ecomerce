    ...
    value: function _recursive() {
      ...
      children.forEach(function(child) {
        if (child.children instanceof Array) {
          ...
          components = components.concat(helpers.filter(function(c3) {
            return _this._isMatched(c3, child.key);
          }).map(function(c3) {
            return c3.vnode;
          }));
        }
...
var script = {
  ...
  methods: {
    ...
    _loadGlobalStyles: function _loadGlobalStyles() {
      ...
      s2(globalCSS) && BaseStyle.load(globalCSS, _objectSpread({
        name: "global"
      }, this.$styleOptions));
    },
...
function _toConsumableArray5(r) {
  return _arrayWithoutHoles5(r) || _iterableToArray6(r) || _unsupportedIterableToArray7(r) || _nonIterableSpread5();
}
...
var Ripple = BaseRipple.extend("ripple", {
  ...
  methods: {
    ...
    getInk: function getInk(el) {
      return el && el.children ? _toConsumableArray5(el.children).find(function(child) {
...
//# sourceMappingURL=chunk-42WHQBVB.js.map
