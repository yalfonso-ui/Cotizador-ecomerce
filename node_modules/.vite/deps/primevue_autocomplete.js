  ...
  methods: {
    ...
    onOptionSelect: function onOptionSelect(event, option2) {
      ...
      if (this.multiple) {
        ...
        if (!this.isSelected(option2)) {
          this.updateModel(event, [].concat(_toConsumableArray2(this.d_value || []), [value]));
        }
      } else {
    ...
    onOptionSelectRange: function onOptionSelectRange(event) {
      ...
      if (start !== -1 && end !== -1) {
        ...
        this.updateModel(event, [].concat(_toConsumableArray2(this.d_value || []), _toConsumableArray2(value)));
      }
    },
      ...
      if (!this.typeahead) {
        if (this.multiple) {
          if (event.target.value.trim()) {
            this.updateModel(event, [].concat(_toConsumableArray2(this.d_value || []), [event.target.value.trim()]));
            this.$refs.focusInput.value = "";
          }
          event.preventDefault();
        }
